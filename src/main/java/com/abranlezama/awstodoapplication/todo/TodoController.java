...
public class TodoController {
    ...
    @GetMapping("/show/{id}")
    public String showView(@AuthenticationPrincipal OidcUser user,
        ...
        log.info("Showing todo with id {}", id);
    ...
    @PostMapping
    public String add(@Valid Todo toBeCreatedTodo,
    ...
    @GetMapping("/edit/{id}")
    public String editView(@AuthenticationPrincipal OidcUser user,
                           @PathVariable("id") long id,
                           Model model) {
        Todo todo = todoService.getOwnedOrSharedTodo(id, user.getEmail());
    ...
    public String update(@AuthenticationPrincipal OidcUser user,
                         @PathVariable("id") long id,
    ...
    public String delete(@AuthenticationPrincipal OidcUser user,
                         @PathVariable("id") long id,
                         RedirectAttributes redirectAttributes) {
